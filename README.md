...
　　・問題を登録できる
　　・各問題にタグづけすることができる
　　・ユーザー一覧を見ることができ、ユーザーの編集・削除ができる
　　・レッスン・動画の欄に動画を埋め込むことができる。
本リリース時の実装
【団体による登録・教員・生徒】
　　・phonicsの問題を解ける
　　・phonicsのレッスンを受けられる
　　・団体登録を行い、生徒や教員(講師)のアカウントを登録できる
　　・生徒の正答率を分析して、苦手な問題や正答率の低い問題を出すことができる→授業構成の参考になるため
　　・宿題を登録して、通知が生徒のアプリや保護者のメールに届く
...
![ER図](../phonics_trainer_er_figure.png)